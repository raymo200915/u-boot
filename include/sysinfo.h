...
enum sysinfo_id {
	 ...
	 * SYSINFO_CACHE_LVL_MAX of cache
	 */
	SYSINFO_ID_SMBIOS_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_INFO_START,
	SYSINFO_ID_SMBIOS_CACHE_CONFIG = SYSINFO_ID_SMBIOS_CACHE_INFO_START,
	...
	SYSINFO_ID_SMBIOS_CACHE_CURR_SRAM_TYPE = \
		SYSINFO_ID_SMBIOS_CACHE_SUPP_SRAM_TYPE + SYSINFO_CACHE_LVL_MAX,
	SYSINFO_ID_SMBIOS_CACHE_SPEED = \
		SYSINFO_ID_SMBIOS_CACHE_CURR_SRAM_TYPE + SYSINFO_CACHE_LVL_MAX,
	...
	SYSINFO_ID_SMBIOS_CACHE_SYS_CACHE_TYPE = \
		SYSINFO_ID_SMBIOS_CACHE_ERR_CORR_TYPE + SYSINFO_CACHE_LVL_MAX,
	SYSINFO_ID_SMBIOS_CACHE_ASSOCIATIVITY = \
		SYSINFO_ID_SMBIOS_CACHE_SYS_CACHE_TYPE + SYSINFO_CACHE_LVL_MAX,
	SYSINFO_ID_SMBIOS_CACHE_MAX_SIZE2 = \
		SYSINFO_ID_SMBIOS_CACHE_ASSOCIATIVITY + SYSINFO_CACHE_LVL_MAX,
...
#endif /* CONFIG_IS_ENABLED(SYSINFO_SMBIOS) */
	/* For show_board_info() */
	SYSINFO_ID_BOARD_MODEL = SYSINFO_ID_SMBIOS_CACHE_INFO_END + 1,
