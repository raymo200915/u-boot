...
enum sysinfo_id {
	 ...
	 * SYSINFO_MAX_CACHE_LEVEL of cache
	 */
	SYSINFO_ID_SMBIOS_CACHE_FIRST,
	SYSINFO_ID_SMBIOS_CACHE_CONFIG = SYSINFO_ID_SMBIOS_CACHE_FIRST,
	SYSINFO_ID_SMBIOS_CACHE_MAX_SIZE = \
		SYSINFO_ID_SMBIOS_CACHE_CONFIG + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_INST_SIZE = \
		SYSINFO_ID_SMBIOS_CACHE_MAX_SIZE + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_SUPP_SRAM_TYPE = \
		SYSINFO_ID_SMBIOS_CACHE_INST_SIZE + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_CURR_SRAM_TYPE = \
		SYSINFO_ID_SMBIOS_CACHE_SUPP_SRAM_TYPE + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_SPEED = \
		SYSINFO_ID_SMBIOS_CACHE_CURR_SRAM_TYPE + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_ERR_CORR_TYPE = \
		SYSINFO_ID_SMBIOS_CACHE_SPEED + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_SYS_CACHE_TYPE = \
		SYSINFO_ID_SMBIOS_CACHE_ERR_CORR_TYPE + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_ASSOCIATIVITY = \
		SYSINFO_ID_SMBIOS_CACHE_SYS_CACHE_TYPE + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_MAX_SIZE2 = \
		SYSINFO_ID_SMBIOS_CACHE_ASSOCIATIVITY + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_INST_SIZE2 = \
		SYSINFO_ID_SMBIOS_CACHE_MAX_SIZE2 + SYSINFO_MAX_CACHE_LEVEL,
	SYSINFO_ID_SMBIOS_CACHE_LAST = \
		SYSINFO_ID_SMBIOS_CACHE_INST_SIZE2 + SYSINFO_MAX_CACHE_LEVEL - 1,

	/* For show_board_info() */
	SYSINFO_ID_BOARD_MODEL = SYSINFO_ID_SMBIOS_CACHE_LAST + 1,
